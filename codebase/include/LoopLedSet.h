...
public:
    ...
    void Request_LED_switch(int track, int instrument, bool on); // called by PlayersStatistics - do NOT access to Display
    int Read_LED_activity(int track, int instrument); // called by main
    void Write_LED_activity(int track, int instrument, bool on); // called by main
};
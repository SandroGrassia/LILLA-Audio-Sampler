...
public:
    ...
    // Gestione LED
    void Led_PERFORMANCE_instrument(int instrument, bool on);
    void Led_SOUND_EDIT_instrument(int instrument, bool on);
    ...
    void All_Instrument(uint8_t patch);
    ...
    void Loop_led(int track, int instrument, bool on); // displays track/instrument LED

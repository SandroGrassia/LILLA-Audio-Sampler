...
private:
    ...
    int Performance_menu_frame_position_0 = 0;
...
public:
    ...
    void Frame_performance_menu(int position, bool fresh);
    void Delete_all_frame_performance_menu(void);
    void Confirm_patch_change_popup(void);
    void Confirm_patch_change_popup_frame(int value);
    ...
    void Confirm_patch_delete_popup_frame(int value);
    // Instrument
    void Instruments_header(void);
    void All_Instrument(int patch_id);
    void Show_Instrument_description(int patch_id, int instrument_id, bool editing);
    void Delete_Instrument(int position);
    void Instrument_frame_on_position(float position, bool print);
    // Tuning tone
    void Instrument_TT(int patch_id);
    void Volume_TT(int patch_id);
    ...
    void Frame_LS_menu(int position);

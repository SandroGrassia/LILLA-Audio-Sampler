...
// Firmware version
constexpr char FIRMWARE_VERSION[] = "5.0.0_J 03/01/2026";
...
// Bus SPI1 pins (communication with Display and Shift register chip)
...
static constexpr int SPI1_MISO = 39;        // solo Shift Registers

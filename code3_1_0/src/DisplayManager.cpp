...
void DisplayManager::D_modulation_type(void)
{
    ...
    tft.setTextColor(ILI9341_YELLOW);
    if (Delay_values.modulation_source == 0)
        tft.print("NONE"); // nessuna modulazione
    else if (Delay_values.modulation_source == 1)
        tft.print("LFO"); // LFO
    else
        tft.print("SOURCE");
}
...
void DisplayManager::MX_source_values_write(const uint8_t source)
{
    ...
    else
    {
        ...
        {
            if (abs(Sound[local_id_sound].pan) < 10)
                tft.setCursor(x_pos(MX_X0 + source * 5), y_pos(MX_Y0 + 3)); // Pan
            else
                tft.setCursor(x_pos(MX_X0 - 0.5 + source * 5), y_pos(MX_Y0 + 3)); // Pan
...
{
    tft.drawLine(x_pos(0), FileCopy_BAR_POS_Y, x_pos(0), FileCopy_BAR_POS_Y + 5, ILI9341_YELLOW);
    tft.setCursor(x_pos(0) + 10, FileCopy_BAR_POS_Y);
    tft.setTextColor(ILI9341_YELLOW);
    tft.print("0%");
}

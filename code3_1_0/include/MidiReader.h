...
extern MIDI_NAMESPACE::SerialMIDI<HardwareSerial> serialMIDI;                          // Define your transport
...
public:
    ...
    */
    ...
    WaveVibrato *_Vibrato = nullptr; // Midi_reader._Vibrato = &Vibrato
    WaveSine *_Tone_generator = nullptr;
    LoopLedSet *_LOOP_led_set = nullptr;
    PlayersManager *_Players_Manager = nullptr;
